...
ALARM_PATH := vendor/bloom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/bloom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/bloom/prebuilt/common/media/audio/ringtones
